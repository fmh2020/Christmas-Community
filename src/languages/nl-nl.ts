...
export const strings = {
  ...
  WISHLIST_MOVE_ITEM_TOP: 'Zet item bovenaan',
  WISHLIST_MOVE_ITEM_BOTTOM: 'Zet item onderaan',
  ...
  WISHLIST_PLEDGE_DUPLICATE: 'Item is al door iemand geclaimd',
  WISHLIST_PLEDGE_ITEM: 'Beloof item',
  WISHLIST_PLEDGE_SUCCESS: 'Item is door je geclaimd!',
  WISHLIST_PLEDGE: 'Claim',
  WISHLIST_PLEDGED: (pledgedBy) => `Geclaimd door ${pledgedBy}`,
  WISHLIST_PLEDGED_GUEST: 'Geclaimd door een gast',
  WISHLIST_PLEDGED_ITEM_FOR_USER: (user) => `Item geclaimd voor ${user}.`,
  ...
  WISHLIST_UNPLEDGE_GUARD: 'Dit heb jij niet geclaimd', // should never happen unless someone makes their own http requests
  WISHLIST_UNPLEDGE_SUCCESS: 'Claim voor item verwijderd!',
  WISHLIST_UNPLEDGE: 'Verwijder claim',
  WISHLIST_URL_LABEL: `Item URL of naam`,
